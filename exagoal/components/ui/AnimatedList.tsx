...
export default function AnimatedList<T>({
  ...
  return (
    <div className={`scroll-list-container w-full ${className}`}>
      <div ref={listRef} className={`scroll-list ${!displayScrollbar ? 'no-scrollbar' : ''}`} onScroll={handleScroll}>
        {items.map((item, index) => (
          ...
          >
            <div className={`w-full ${selectedIndex === index ? 'ring-2 ring-primary ring-offset-2 ring-offset-background rounded-2xl' : ''} ${itemClassName}`}>
